...
customerForm.addEventListener("submit", function validate(e) {
  ...
  if(usernameInput.value.length >= 5 && usernameInput.value.length <= 16){
    ...
    document.querySelector(".validation-1").innerHTML = "The name must be more than 5 characters";
  ...
  if(selectType.value === "none"){
    document.querySelector(".validation-3").innerHTML = "You must choose type";
